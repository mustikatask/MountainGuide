...
public class HikingGuideAdapter extends RecyclerView.Adapter<HikingGuideAdapter.myviewholder> {
    ArrayList<HikingGuideModel> dataList;

    public HikingGuideAdapter(ArrayList<HikingGuideModel> dataList) {
